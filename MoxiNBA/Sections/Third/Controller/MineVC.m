...
{
    //充值余额
    NSMutableAttributedString *mattrstring_charge = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@元",[[UserInfo sharedInstance]Balance]]];
...
//                               range:NSMakeRange(mattrstring_charge.length-5, 1)];
    ...
    //中奖余额
    NSMutableAttributedString *mattrstring_win = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@元",[[UserInfo sharedInstance]Cash]]];
